...
export class ExchangeRates extends ethereum.SmartContract {
  ...
  aggregatorKeys(param0: BigInt): Bytes {
    let result = super.call(
      "aggregatorKeys",
      "aggregatorKeys(uint256):(bytes32)",
  ...
  currencyKeyDecimals(param0: Bytes): i32 {
    let result = super.call(
      "currencyKeyDecimals",
      "currencyKeyDecimals(bytes32):(uint8)",
      [ethereum.Value.fromFixedBytes(param0)]
    );
  ...
  currentRoundForRate(param0: Bytes): BigInt {
    let result = super.call(
      "currentRoundForRate",
      "currentRoundForRate(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(param0)]
    );
  ...
  getCurrentRoundId(currencyKey: Bytes): BigInt {
    let result = super.call(
      "getCurrentRoundId",
      "getCurrentRoundId(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(currencyKey)]
    );
  ...
  try_inversePricing(
    param0: Bytes
  ): ethereum.CallResult<ExchangeRates__inversePricingResult> {
    let result = super.tryCall(
      "inversePricing",
      "inversePricing(bytes32):(uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  lastRateUpdateTimes(currencyKey: Bytes): BigInt {
    let result = super.call(
      "lastRateUpdateTimes",
      "lastRateUpdateTimes(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(currencyKey)]
    );
  ...
  rateAndInvalid(currencyKey: Bytes): ExchangeRates__rateAndInvalidResult {
    let result = super.call(
      "rateAndInvalid",
      "rateAndInvalid(bytes32):(uint256,bool)",
      [ethereum.Value.fromFixedBytes(currencyKey)]
    );

    return new ExchangeRates__rateAndInvalidResult(
      result[0].toBigInt(),
      result[1].toBoolean()
    );
  }
  ...
  try_rateAndInvalid(
    currencyKey: Bytes
  ): ethereum.CallResult<ExchangeRates__rateAndInvalidResult> {
    let result = super.tryCall(
      "rateAndInvalid",
      "rateAndInvalid(bytes32):(uint256,bool)",
      [ethereum.Value.fromFixedBytes(currencyKey)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ExchangeRates__rateAndInvalidResult(
        value[0].toBigInt(),
        value[1].toBoolean()
      )
    );
  ...
  try_rateAndTimestampAtRound(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ExchangeRates__rateAndTimestampAtRoundResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  rateAndUpdatedTime(
    currencyKey: Bytes
  ): ExchangeRates__rateAndUpdatedTimeResult {
    let result = super.call(
      "rateAndUpdatedTime",
    ...
    return new ExchangeRates__rateAndUpdatedTimeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_rateAndUpdatedTime(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ExchangeRates__rateAndUpdatedTimeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  rateForCurrency(currencyKey: Bytes): BigInt {
    let result = super.call(
      "rateForCurrency",
      "rateForCurrency(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(currencyKey)]
    );
  ...
  ratesForCurrencies(currencyKeys: Array<Bytes>): Array<BigInt> {
    let result = super.call(
      "ratesForCurrencies",
      "ratesForCurrencies(bytes32[]):(uint256[])",
      [ethereum.Value.fromFixedBytesArray(currencyKeys)]
    );
  ...
  updateRates(
    ...
    let result = super.call(
      "updateRates",
      "updateRates(bytes32[],uint256[],uint256):(bool)",
      [
        ethereum.Value.fromFixedBytesArray(currencyKeys),
